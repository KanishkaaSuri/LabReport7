...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\kanis\\Desktop\\Lab in Psychology\\7. Intentional Binding Task\\Intentional Binding Task_lastrun.py',
...
trials = data.TrialHandler(nReps=5.0, method='random', 
    ...
    trialList=data.importConditions('cons.xlsx'),
